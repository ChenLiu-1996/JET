...
## Installation
Please refer to the [installation guide](Documentation/Installation_Guide.txt).

## User Manual
The user guide can be found in both [PDF](Documentation/JET_1.0_UserManual.pdf) and in [PowerPoint](Documentation/JET_1.0_UserManual.pptx). The **most comprehensive** details can be found in the [Technical White Paper](Documentation/JET_1.0_TechnicalWhitePaper.pdf).
